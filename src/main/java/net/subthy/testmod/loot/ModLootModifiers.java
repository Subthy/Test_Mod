...
public class ModLootModifiers {
    ...
    public static final RegistryObject<Codec<? extends IGlobalLootModifier>> HIDE_BONES =
            LOOT_MODIFIER_SERIALIZERS.register("hide_bones", HideBonesLootModifier.CODEC);
