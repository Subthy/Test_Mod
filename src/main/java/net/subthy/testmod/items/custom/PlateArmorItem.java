...
import net.subthy.testmod.items.ModArmorMaterials;
import net.subthy.testmod.items.custom.client.PlateArmorRenderer;
...
public class PlateArmorItem extends ArmorItem implements GeoItem {
    private AnimatableInstanceCache cache = new SingletonAnimatableInstanceCache(this);

    public PlateArmorItem(ArmorMaterial material, Type type, Properties properties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private PlateArmorRenderer renderer;

            @Override
            public @NotNull HumanoidModel<?> getHumanoidArmorModel(LivingEntity livingEntity, ItemStack itemStack,
                                                                   EquipmentSlot equipmentSlot, HumanoidModel<?> original) {
                if (this.renderer == null)
                    this.renderer = new PlateArmorRenderer();
    ...
    // Adding effects to players on full set of armor



    private static final Map<ArmorMaterial, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.Plate_Armor, List.of(new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 200, 1),
